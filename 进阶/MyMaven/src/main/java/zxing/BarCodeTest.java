...
public class BarCodeTest {
    public static void main(String[] args) throws Exception {
        generateCode(new File("F:\\School\\Notebook\\pics\\二维码\\myCode_01.png"), "520520520", 500, 250);
        readCode(new File("F:\\School\\Notebook\\pics\\二维码\\myCode_01.png"));
    }
    ...
    public static void readCode(File file) {
        try {
            ...
            System.out.println("条形码的内容：" + result.getText());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
